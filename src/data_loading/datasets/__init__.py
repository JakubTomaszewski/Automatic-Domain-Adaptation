...
def get_dataset(dataset_name: str, meta_file: str, transforms: callable = None, is_test: bool = False):
    dataset, dataset_root_dir, dataset_class_names = dataset_dict[dataset_name]
    return dataset(dataset_root_dir, dataset_class_names, meta_file, transforms, is_test)